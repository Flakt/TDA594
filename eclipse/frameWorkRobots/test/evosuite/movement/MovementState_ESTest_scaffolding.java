...
public class MovementState_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "movement.MovementState"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MovementState_ESTest_scaffolding.class.getClassLoader() ,
      "robocode.Robot",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MovementState_ESTest_scaffolding.class.getClassLoader()); 
