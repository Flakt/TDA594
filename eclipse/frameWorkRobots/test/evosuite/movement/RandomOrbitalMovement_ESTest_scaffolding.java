...
public class RandomOrbitalMovement_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "movement.RandomOrbitalMovement"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RandomOrbitalMovement_ESTest_scaffolding.class.getClassLoader() ,
      "robocode.Robot",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("robocode.robotinterfaces.peer.IBasicRobotPeer", false, RandomOrbitalMovement_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RandomOrbitalMovement_ESTest_scaffolding.class.getClassLoader()); 
